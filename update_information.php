  ...
  <tr>
	...
	if(isset($_POST['send'])){
		...
		if(empty($f_name) || empty($l_name) || empty($country) || empty($date_b) || empty($home_address) || empty($email_address) || empty($phone_number) || empty($position)){
			...
			$employees->update_employees($id_employees,$f_name,$l_name,$m_name,$position,$country,$date_b,$home_address,$email_address,$phone_number,$status_e);
